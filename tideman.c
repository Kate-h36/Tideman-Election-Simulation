...
bool lock_pairs(void)
{
    ...
    {
        // check if locking in this pair creates a cycle
    ...
    // always return true at the end of the function
    return true;
}

// Check for cycles in locked pairs
bool creates_cycle(int winner, int loser)
{
    if (winner == loser)
    {
